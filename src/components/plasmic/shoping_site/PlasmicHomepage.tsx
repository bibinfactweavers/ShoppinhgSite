...
import sty from "./PlasmicHomepage.module.css"; // plasmic-import: xGr9rBA9dxLF/css
              ...
              <ph.DataCtxReader>
                {$ctx => (
                  <a
                    ...
                    href={(() => {
                      try {
                        return "/product/" + $ctx.currentProduct.slug;
                      } catch (e) {
                        if (e instanceof TypeError) {
                          return `/product/${"bomber-jacket"}`;
                        }
                        throw e;
                      }
                    })()}
...
const PlasmicDescendants = {
  ...
  link: ["link", "productMedia", "productTextField"],
